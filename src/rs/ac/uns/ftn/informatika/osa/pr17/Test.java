package rs.ac.uns.ftn.informatika.osa.pr17;
...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("Exception / TestApplication 1: " + ex.getMessage());
    } finally {
      manager.close();
    }
    ...
    try {
      ...
      System.out.println("Exception / TestApplication 2: " + ex.getMessage());
    }
    
    // umesto lazy fetching radimo eager fetching pomocu JPQL upita
    System.out.println(
        "\n==== TestApplication 3: Citamo hijerarhijski sve kategorije pomocu eager fetching");
    manager = factory.createEntityManager();
    try {
      Query q1 = manager.createQuery(
      ...
      System.out.println("Exception / TestApplication 3: " + ex.getMessage());
    }
    ...
    // klasi Supplier!
    System.out.println(
        "\n==== TestApplication 4: Dodajemo novog dobavljaca i dva proizvoda");
    ...
    try {
      ...
      System.out.println("Exception / TestApplication 4: " + ex.getMessage());
    }
    ...
    try {
      ...
      System.out.println("Exception / TestApplication 5: " + ex.getMessage());
    }
