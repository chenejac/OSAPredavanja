...
<jsp:useBean id="user" scope="session" class="rs.ac.uns.ftn.informatika.osa.pr19.entity.User"/>
<jsp:useBean id="order" scope="session" class="rs.ac.uns.ftn.informatika.osa.pr19.entity.PurchaseOrder"/>
<html>
  <head>
