package rs.ac.uns.ftn.informatika.osa.pr23.surrogate;
 ...
 */
@Entity
@Table(name="pr23_sequence")
@SequenceGenerator(
    name="pr23_idseq", 
    sequenceName="pr23_gen", 
    initialValue=1, 
    allocationSize=1)
public class PrimerSequence {

  @Id
  @GeneratedValue(strategy=SEQUENCE, generator="pr23_idseq")
  @Column(name="id")
  private Integer id;
