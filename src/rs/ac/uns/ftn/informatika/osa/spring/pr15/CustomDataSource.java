...
public class CustomDataSource implements DataSource {
	...
	public CustomDataSource() {
		super();
		ResourceBundle rb = PropertyResourceBundle.getBundle("rs.ac.uns.ftn.informatika.osa.spring.pr15.connection");
	 ...
	 * 
	 */
	public CustomDataSource(String hostname, String port, String schema, String connectionParameters, String username, String password) {
		super();
