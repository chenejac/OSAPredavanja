package rs.ac.uns.ftn.informatika.osa.pr16;
...
public class AdminTest {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Query query = manager.createQuery("SELECT a FROM Admin a WHERE id>?1");
      ...
      Query q = manager.createQuery("DELETE Admin a WHERE a.id > 1");
